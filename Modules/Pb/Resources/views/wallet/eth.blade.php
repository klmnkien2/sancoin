                                        ...
                                        <div class="clearfix form-inner">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="input-group">
                                                    ...
                                                    <input type="text" name="amount" class="form-control" placeholder="ETH">
                                                </div>
                                            </div>
                                            ...
                                            <div class="button-group">
                                                {{ csrf_field() }}
                                                <input type="hidden" name="coin_type" value="eth">
                                        ...
                                        <table class="table table-striped">
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    @endif
                                                    <td><a href="https://etherscan.io/tx/{{$transaction['hash']}}" class="address-tag">{{$transaction['hash']}}</a></td>
                                                    <td>{{ Carbon\Carbon::createFromTimestamp($transaction['timeStamp'])->diffForHumans() }}</td>
                                                    <td><a href="https://etherscan.io/address/{{$transaction['from']}}" class="address-tag">{{$transaction['from']}}</a></td>
                                                    <td><a href="https://etherscan.io/address/{{$transaction['to']}}" class="address-tag">{{$transaction['to']}}</a></td>
